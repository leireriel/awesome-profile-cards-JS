...
const saveLocalStorage = (e) => {
  ...
  const inputName = trigger.name;

  userInfo[inputName] = inputValue;

  // console.log(userInfo);

  localStorage.setItem('userInfoLS', JSON.stringify(userInfo));
};
...
//RESET LOCAL STORAGE
const resetLS = () => localStorage.removeItem('userInfoLS');

resetbutton.addEventListener('click', resetLS);
